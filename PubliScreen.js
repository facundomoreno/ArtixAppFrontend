        ...
        <Intro>Publica un producto</Intro>
          ...
          <TextIn
              ...
              <PickIn>
                ...
                <PickIn.Item label="Arte, Librería y Mercería" value="art-lib-mer" />
                ...
                <PickIn.Item label="Electrodomésticos y Aires Ac." value="elec-aires" />
                ...
                <PickIn.Item label="Hogar, Muebles y Jardín" value="hog-mueb-jard" />
                ...
                <PickIn.Item label="Libros, Revistas y Comics" value="lib-rev-com" />
                <PickIn.Item label="Música, Películas y Series" value="mus-pel-ser" />
                <PickIn.Item label="Ropa y Accesorios" value="rop-acc" />
                <PickIn.Item label="Salud y Equipamiento Médico" value="sal-eq-med" />
                <PickIn.Item label="Souvenirs, Cotillón y Fiestas" value="sou-cot-fie" />
